...
class WhatsAppService
{
    ...
    public static function getTemplate($type, $data = [])
    {
        $templates = [
            ...
            'expert_approved'  => "مبروك! تم تفعيل حسابك كخبير في تطبيق ثمن. الحين تقدر تستلم طلبات التثمين وتبدأ رحلتك معنا. نورتنا يا وحش!\nللدخول السريع لحسابك: " . url('/expert/login'),
            'expert_order_done'=> "كفو يا وحشنا! 🎉 أتممت تثمين الطلب رقم {$data['id']} بنجاح ومشكور على الجهد والدقة. العميل وصلته نتيجة التثمين الحين. استمر بهالمستوى ونتطلع لطلبات أكثر معاك! 🌟",
