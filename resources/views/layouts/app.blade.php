    ...
    <div class="breadcrumb-header justify-content-between align-items-center">
        <div class="left-content d-flex align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div class="mg-l-3">
                    <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1" style="font-family: 'Cairo', sans-serif; font-weight: 700;">
						...
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ \App\Models\User::all()->count() }}</h4>
