...
<body>
    ...
    <section class="reg-section">
        <div class="reg-info" data-aos="fade-left">
            ...
            <p>نحن نبحث عن أفضل الكفاءات في مجالات التقييم الفني والتقني. انضم إلينا وساهم في بناء مستقبل التثمين الذكي.
            </p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" required
                            style="width: 100%; padding: 0.9rem 1.2rem; background: var(--bg-alt); border: 1px solid var(--border); border-radius: 12px; font-family: inherit; font-size: 1rem; cursor: pointer; appearance: none; -webkit-appearance: none; background-image: url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%231A1A1A%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E'); background-repeat: no-repeat, repeat; background-position: left .7em top 50%, 0 0; background-size: .65em auto;">
                    ...
                    <div class="form-group full">
                        ...
                        <textarea name="experience" rows="3"
                            placeholder="اشرح باختصار خبراتك في مجال التقييم..."></textarea>
                    </div>
                    <div class="form-group full">
                        <label>المؤهلات والشهادات</label>
                        <textarea name="certificates" rows="2"
                            placeholder="الشهادات المهنية أو الدورات الحاصل عليها..."></textarea>
                    </div>
                    <div class="form-group full"
