        ...
        <div class="form-wrapper">
            ...
            <div class="balance-info">
                <div>
                    ...
                    <h5 class="mb-0 fw-bold text-success">{{ number_format(auth()->user()->balance, 2) }} <small>SAR</small>
                    </h5>
                </div>
            ...
            <form action="{{ route('withdrawals.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group" style="flex-direction: row-reverse;">
                        <span class="input-group-text"
                            style="border-radius: 12px 0 0 12px; border-right: none; border-left: 2px solid #f1f1f1;">SAR</span>
                        <input type="number" name="amount" class="form-control amount-input text-start"
                            style="border-radius: 0 12px 12px 0; border-left: none;" min="1"
                            max="{{ auth()->user()->balance }}" step="0.01" placeholder="0.00" required>
                    </div>
                    <small class="text-muted mt-2 d-block"><i class="bx bx-info-circle"></i> يمكنك سحب أي مبلغ بحد أقصى
                        للرصيد المتاح.</small>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" class="form-control" rows="3"
                        placeholder="أدخل أي ملاحظات إضافية بخصوص التحويل البنكي..."></textarea>
                </div>
                ...
                <p class="text-center text-muted mt-3 mb-0" style="font-size: 0.85rem;">
                    <i class="bx bx-lock-alt"></i> يتم مراجعة وتحويل الطلب بأمان عبر إدارة تطبيق ثمن.
                </p>
            </form>
        </div>
