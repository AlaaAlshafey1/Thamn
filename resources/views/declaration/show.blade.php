...
<head>
    ...
    <style>
        * {
        ...
        .field-inp:focus {
            border-bottom: 1.5px solid #c9933a;
        }
        ...
        .article-content-col ul li::before {
            content: '• ';
            color: #c9933a;
        }
        ...
        .btn-submit:hover {
            ...
            box-shadow: 0 8px 24px rgba(201, 147, 58, 0.5);
        }
    ...
    <div class="doc-shell">
        ...
        <div class="doc-content">
            ...
            @if($declaration->isSigned())
                ...
                <div class="signed-block">
                    ...
                    <div class="signed-info">
                        <div class="signed-info-row"><span class="l">الاسم</span><span
                                class="v">{{ $declaration->full_name }}</span></div>
                        <div class="signed-info-row"><span class="l">رقم الهوية</span><span
                                class="v">{{ $declaration->national_id }}</span></div>
                        <div class="signed-info-row"><span class="l">تاريخ التوقيع</span><span
                                class="v">{{ $declaration->signed_at->format('d/m/Y') }}</span></div>
                    </div>
            ...
            @else
                ...
                <form id="declarationForm" action="{{ route('declaration.submit', ['token' => $token]) }}" method="POST">
                    @csrf
                    ...
                    <div class="fields-box">
                        <div class="fields-row">
                            ...
                            <div class="field-cell">
                                ...
                                <input type="text" name="city" id="city" class="field-inp" placeholder="الرياض">
                            </div>
                        </div>
                        <div class="fields-row">
                            <div class="field-cell">
                                ...
                                <input type="text" name="national_id" id="national_id" class="field-inp"
                                    placeholder="1XXXXXXXXX" maxlength="10" required value="{{ old('national_id') }}">
                            </div>
                            <div class="field-cell">
                    ...
                    <div class="decl-text-box">
                        الموقع أدناه بالاطلاع على محتوى الوثيقة والإقرار فيها بما ورد فيها بالبنود الواردة في سياق التعاون
                        مع التطبيق في مجال ( التثمين للسلع المستعملة) وأن يكون مؤهلاً للتحكيم التسعيري للمنتج المستعمل إما
                        بتزكية رسمية أو أكاديمية أو فخرية وعليه إرفاق مايثبت ويعزز ذلك.
                    </div>
                    ...
                    <div class="articles-section">
                        ...
                        <div class="article-row">
                            ...
                            <div class="article-content-col">
                                ...
                                <ol>
                                    <li>
                                        <strong>(1) السرية وحماية خصوصية البيانات ( Confidentiality &amp; Data Protection
                                            )</strong><br>
                                        <ul>
                                            <li>تعريف المعلومات السرية : تشمل المعلومات السرية كل ما يطلع عليه المحكم أثناء
                                                عمله، بما في ذلك (بيانات المستخدمين الشخصية، صور المنتجات، فواتير الشراء،
                                                تقارير الفحص الفني، آليات التسعير الخاصة بالتطبيق، أو أي معلومات برمجية أو
                                                تقنية داخل المنصة ).</li>
                                        </ul>
                                    </li>
                                    <li>(2) حظر الاستخدام الشخصي: يلتزم المحكم بعدم استخدام أي معلومة حصل عليها بطريقة
                                        مباشرة لمنفعته الشخصية أو لمنفعة أطراف ثالثة . كما يُحظر عليه التواصل مع أصحاب
                                        المنتجات مباشرة خارج إطار التطبيق لأي سبب كان.</li>
                                    <li>(3) حظر النسخ والتخزين: يُمنع المحكم منعاً باتاً من أخذ لقطات شاشة (Screenshots)
                                        لبيانات المستخدمين أو تحميل وحفظ صور المنتجات والتقارير في أجهزته الشخصية إلا
                                        للضرورة القصوى التي يقتضيها التحكيم، ويلتزم بحذفها فور انتهاء العملية.</li>
                                    <li>(4) أمن الضرورة: المحكم مسؤول مسؤولية كاملة عن سرية بيانات دخوله، وأنه لن يشاركها مع
                                        أي جهة.</li>
                                    <li>(5) مدة الالتزام: يظل هذا البند سارياً طوال مدة تعاقده مع التطبيق، وبعده (3 سنوات)
                                        بعد إنهاء العلاقة التعاقدية لأي سبب كان.</li>
                                    <li>(6) التعويض عن الإفصاح: في حال ثبت تسريب، المحكم ملزم بدفع تعويض عن سرية معلومة سرية
                                        يُقدر بـ ( 10,000 ريال )، بالإضافة إلى حق التطبيق في المطالبة بالتعويض عن الأضرار
                                        الفعلية.</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="article-row">
                            ...
                            <div class="article-content-col">
                                <p>تأسيس علاقة مهنية مع محكمين بنظام العمل الحر ( Freelance ) يتطلب بنوداً تجمع بين الدقة
                                    التقنية والالتزام القانوني :</p>
                                <ol>
                                    <li><strong>(1) معايير التقييم والنزاهة (Technical Integrity):</strong>
                                        <ul>
                                            <li>الالتزام بالدليل الإرشادي: يجب أن يعتمد المحكم دائماً الدليل الإرشادي الصادر
                                                عن إدارة التطبيق.</li>
                                            <li>دقة البيانات: المحكم مسؤول عن مراجعة الصور والمستندات المرفوعة والتأكد من
                                                مطابقتها للإثبات التقنية المطلوبة.</li>
                                            <li>الحيادية: يُمنع التلاعب بالتثمين لرفع أو خفض قيمة المنتج لأسباب غير موضوعية.
                                            </li>
                                        </ul>
                                    </li>
                                    <li><strong>(2) نطاق العمل والمسؤولية (Scope of Work):</strong>
                                        <ul>
                                            <li>زمن الاستجابة (SLA): تحديد مهلة مضمونة لكل عملية تحكيم (مثلاً: اكتمال الطلب
                                                خلال 30 دقيقة من وصول الطلب).</li>
                                            <li>التوثيق: يصدر قرار المحكم توثيقياً في حال ثبت وجود خطأ جسيم أو مخالفة
                                                للمعايير التقنية.</li>
                                        </ul>
                                    </li>
                                    <li><strong>(3) السرية وخصوصية البيانات (Confidentiality):</strong>
                                        <ul>
                                            <li>حماية البيانات: يحظر على المحكم الاحتفاظ بصور المنتجات أو بيانات المستخدمين
                                                أو استخدامها خارج إطار التطبيق.</li>
                                            <li>الملكية الفكرية: جميع التقارير والنتائج التي يصدرها المحكم هي ملك حصري
                                                للتطبيق.</li>
                                        </ul>
                                    </li>
                                    <li><strong>(4) آلية المحاسبة المالية (Payment Terms):</strong>
                                        <ul>
                                            ...
                                            <li>الخصومات: يحق للتطبيق خصم قيمة العمولة أو إلغائها في حال ثبت طعن المحتكمين
                                                أو تكرار الأخطاء.</li>
                                        </ul>
                                    </li>
                                    <li><strong>(5) بند "العمل الحر" والقانون (Legal Status):</strong>
                                        <ul>
                                            <li>استقلالية المحكم: الأكيد على أن العلاقة مع المنصة هي "تعاقد مستقل" وليست
                                                علاقة توظيف.</li>
                                            <li>عدم المنافسة: يُمنع المحكم من العمل مع تطبيقات مباشرة منافسة خلال فترة
                                                التعاقد.</li>
                                        </ul>
                                    </li>
                                    <li><strong>(6) إنهاء التعاقد (Termination):</strong> يحق للتطبيق إيقاف حساب المحكم
                                        فوراً في حالات: (إفشاء الأسرار، التواطؤ، التأخير المكرر، أو ثبوت الغش والاحتيال
                                        بناءً على تقييمات المستخدمين).</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="article-row">
                            ...
                            <div class="article-content-col">
                                <p>يقوم المحكم بالدخول على رابط الانضمام والإقرار بالوثيقة وبعد ذلك يتم تمكينه من استقبال
                                    عروض التثمين ومراجعتها. يُقيّم العرض وفق الآلية التثمينية للمنتج بتقدير ثلاث قيم ( الحد
                                    الأدنى / السعر العادل / الحد الأعلى ). ويحصل إزاء كل بطاقة ثمين بهامش عمولة تقدر بـ ( SR
                                    10 ) عن كل بطاقة ثمين منجزة بنجاح بعد مرور ( 24 - 48 ساعة ) من عملية التثمين وذلك
                                    بتحويلها إلى حسابه المدون في صفحته وفق آلية التطبيق.</p>
                            </div>
                        </div>
                        ...
                        <div class="article-row">
                            ...
                            <div class="article-content-col">
                                <ol>
                                    <li>(1) دقة التقييم : يُقر "المحكم" بأن كافة التقارير والنتائج الصادرة عنه مبنية على أسس
                                        مهنية وموضوعية ، وأنه مسؤول مسؤولية كاملة عن مراجعة كافة الصور والمستندات المرفقة
                                        بالطلب بدقة وعناية فائقة .</li>
                                    <li>(2) حدود المسؤولية : لا يتحمل المحكم المسؤولية عن العيوب "الخفية" التي لا يمكن كشفها
                                        من خلال الصور أو تقارير الفحص المرفقة، بشرط أن يثبت المحكم أنه بذل العناية المهنية
                                        اللازمة وفقاً للدليل الإرشادي للتطبيق .</li>
                                    <li>(3) الخطأ المهني الجسيم : في حال ثبت وجود "خطأ مهني جسيم " ( مثل التغاضي عن كسر واضح
                                        في شاشة جوال ، أو إخفاء صدمة هيكلية في سيارة ، أو تزييف حالة البطارية ) أدى إلى ثمين
                                        المنتج بسعر ( أعلى / أقل ) من قيمته الحقيقية بنسبة تتجاوز (10%) ، يحق لإدارة التطبيق
                                        اتخاذ الإجراءات التالية :
                                        <ul>
                                            <li>تحميل المحكم قيمة الضرر المباشر للمستخدم بحد أقصى ( 3 أضعاف ) أتعابه في تلك
                                                العملية.</li>
                                            <li>التواصل والاحتيال: في حال ثبت تواطؤ بين المحكم وصاحب المنتج لرفع قيمة
                                                التقييم ، يتم إنهاء التعاقد فوراً دون سابق إنذار مع استحقاق التعويض
                                                القانوني.</li>
                                        </ul>
                                    </li>
                                    <li>(4) آلية التظلم : يحق للمحكم الاعتراض على قرارات الخصم أو التقييمات خلال ( 3 أيام
                                        عمل ) من إخطاره ، وتقوم لجنة داخلية بالتطبيق بالفصل في الاعتراضات ويكون قرارها
                                        نهائياً .</li>
                                </ol>
                                <div class="how-box">
                                    <div class="how-title">كيف يطبق هذا البند تقنياً داخل التطبيق ؟</div>
                                    <ul>
                                        <li>نظام تقييم التراكمي ( Accuracy Score ) : إذا بلغ تقييم المحكم في المنصة بمعدل
                                            دقة أقل من 90% يتم إيقافه للمراجعة.</li>
                                        <li>تجميد الاستحقاقات: تجميد نصيب أتعاب المحكم خلال "فترة الاختبار" حتى يتم اعتماد
                                            الطلب بنجاح.</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <label class="read-confirm" for="readConfirm">
                        ...
                        <label for="readConfirm">نعم أقر بالاتفاقية — لقد اطلعت على جميع بنود الوثيقة وأوافق على الالتزام
                            بها كاملاً</label>
                    </label>
        ...
        <div class="doc-footer">
            هذه الوثيقة صادرة رسمياً من <strong>تطبيق ثمن</strong> للتثمين المهني — جميع الحقوق محفوظة © {{ date('Y') }}
        </div>
